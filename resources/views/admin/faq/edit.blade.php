...
@section('subtitle', 'Modifier les informations de la question fréquemment posée')
        ...
        <form action="{{ route('admin.faq.update', $faq) }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <textarea id="answer" 
                          ...
                          placeholder="Votre réponse détaillée...">{{ old('answer', $faq->answer) }}</textarea>
                @error('answer')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <p class="mt-1 text-sm text-slate-500">Les FAQ avec un ordre plus petit apparaîtront en premier</p>
                @error('sort_order')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                <label class="flex items-center">
                    ...
                    <span class="ml-2 text-sm text-slate-700">FAQ active</span>
                </label>
            </div>
