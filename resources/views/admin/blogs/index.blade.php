...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-slate-600">Manage your blog posts and articles</p>
        </div>
    ...
    <form method="GET" action="{{ route('admin.blogs.index') }}" class="bg-slate-50 p-4 rounded-lg border border-slate-200">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <input type="text" name="search" value="{{ request('search') }}" placeholder="Search blogs..." class="w-full px-4 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            ...
            <div class="flex space-x-2">
                ...
                <a href="{{ route('admin.blogs.index') }}" class="flex-1 bg-slate-200 hover:bg-slate-300 text-slate-700 px-4 py-2 rounded-lg font-medium transition-colors duration-200 text-center">Clear</a>
            </div>
        </div>
    </form>
    ...
    @else
        <div class="text-center py-12">
            ...
            <p class="mt-1 text-sm text-slate-500">Start by creating a blog post to engage your audience.</p>
            <div class="mt-6">
                <a href="{{ route('admin.blogs.create') }}" 
