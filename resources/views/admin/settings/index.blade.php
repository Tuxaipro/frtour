                                            ...
                                            <div class="mt-1">
                                                ...
                                                <div id="current-image-{{ $setting->key }}" class="mb-3 {{ $setting->value ? '' : 'hidden' }}">
                                                    <div class="flex items-center space-x-3">
                                                        ...
                                                        <button type="button" onclick="clearImage('{{ $setting->key }}')" class="p-2 rounded-lg hover:bg-red-50 transition-colors duration-200 text-red-600 hover:text-red-800" title="Remove image">
                                                ...
                                                <div id="new-image-preview-{{ $setting->key }}" class="mb-3 hidden">
                                                    <div class="flex items-center space-x-3">
                                                        ...
                                                        <button type="button" onclick="clearNewImage('{{ $setting->key }}')" class="p-2 rounded-lg hover:bg-red-50 transition-colors duration-200 text-red-600 hover:text-red-800" title="Cancel upload">
                                                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
