                                    ...
                                    <div class="flex items-center">
                                        <div class="flex-shrink-0 h-12 w-12">
                                            @php
                                                ...
                                                $colorIndex = ord(strtoupper(substr($request->first_name, 0, 1))) % count($colors);
                                            ...
                                            <div class="h-12 w-12 rounded-xl {{ $selectedColor }} text-white flex items-center justify-center font-bold text-lg shadow-lg ring-2 ring-white/20">
                                                {{ strtoupper(substr($request->first_name, 0, 1)) }}{{ strtoupper(substr($request->last_name, 0, 1)) }}
                                            </div>
                                        </div>
                                        <div class="ml-4">
                                            <div class="text-sm font-semibold text-slate-900">{{ $request->first_name }} {{ $request->last_name }}</div>
                                ...
                                <td class="px-6 py-4">
                                    <div class="space-y-2">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <span class="text-sm font-medium text-slate-900">{{ $request->number_of_travelers }} voyageur{{ $request->number_of_travelers > 1 ? 's' : '' }}</span>
                                        </div>
                                        @if($request->travel_dates)
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <span class="text-sm text-slate-600">{{ $request->travel_dates }}</span>
                                            </div>
                                        @endif
                                        @if($request->destinations)
                                            ...
                                            @if(count($destinationNames) > 0)
                                                <div class="flex items-center space-x-2">
                                                    ...
                                                    <span class="text-sm text-slate-600">{{ implode(', ', array_slice($destinationNames, 0, 2)) }}{{ count($destinationNames) > 2 ? '...' : '' }}</span>
                                                </div>
                                            @endif
                                        @endif
                                        @if($request->travel_style)
                                            <div class="flex items-center space-x-2">
                                                ...
                                                <span class="text-sm text-slate-600">{{ ucfirst($request->travel_style) }}</span>
                                            </div>
                                        @endif
                                    </div>
                                </td>
