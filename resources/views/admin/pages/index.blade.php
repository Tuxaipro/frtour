...
<div class="space-y-6">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-sm text-slate-600 mt-1.5 font-medium">Manage static pages for your website</p>
        </div>
    ...
    <form method="GET" action="{{ route('admin.pages.index') }}" class="bg-white rounded-2xl shadow-lg border border-slate-200/50 p-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <input type="text" name="search" value="{{ request('search') }}" placeholder="Search pages..." class="w-full px-4 py-3 border-2 border-slate-200 rounded-xl focus:ring-2 focus:ring-primary focus:border-primary transition-all duration-200 text-slate-900 placeholder-slate-400">
            ...
            <div class="flex space-x-3">
                ...
                <a href="{{ route('admin.pages.index') }}" class="flex-1 bg-white hover:bg-slate-50 text-slate-700 border-2 border-slate-200 px-5 py-3 rounded-xl font-semibold transition-all duration-200 text-center shadow-sm hover:shadow-md">Clear</a>
            </div>
        </div>
    </form>
    ...
    @if($pages->count() > 0)
        <div class="bg-white rounded-2xl shadow-lg border border-slate-200/50 overflow-hidden">
            <div class="px-6 py-4 border-b border-slate-200 bg-gradient-to-r from-slate-50 to-white">
                ...
                <p class="text-xs text-slate-600 mt-1">Total: {{ $pages->count() }} page(s)</p>
            </div>
    ...
    @else
        <div class="bg-white rounded-2xl shadow-lg border border-slate-200/50 p-12 text-center">
            <div class="max-w-md mx-auto">
                ...
                <h3 class="text-xl font-bold text-slate-900 mb-2">No pages found</h3>
                <p class="text-sm text-slate-600 mb-8">Start by creating a page to add to your website.</p>
                <a href="{{ route('admin.pages.create') }}" 
